package activity.ljsw.com.ppshopand.widege;
...
import activity.ljsw.com.ppshopand.util.DisplayUtil;
import activity.ljsw.com.ppshopand.util.JStringKit;
...
public class DialogMaker {
	 ...
	 * @return 显示并返回对话框
	 */
	public static Dialog showCommonAlertDialog(Context context, String title, String msg, String[] btns,
											   final DialogCallBack callBack, boolean isCanCancelabel, final boolean isDismissAfterClickBtn, final Object tag)
	{
		final Dialog dialog = new Dialog(context, R.style.DialogNoTitleStyleTransparentBg);
		...
		ViewGroup.MarginLayoutParams mParams = (ViewGroup.MarginLayoutParams) titleTv.getLayoutParams();
...
//		aWmLp.width = PhoenixApplication.getInstance().screenW - 100;
